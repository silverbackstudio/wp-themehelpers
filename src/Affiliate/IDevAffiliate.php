...
class IDevAffiliate implements AffiliateInterface {
	...
	public function sale( $amount, $user_data = array(), $order_num = null, $product_name = null ) {
		...
		return wp_remote_get( $this->base_url . '/sale.php', array(
			'body' => $args,
		) );
	...
	public function lead( $amount = '0.10', $user_data = array(), $order_num = null, $product_name = null ) {
		...
		return wp_remote_get( untrailingslashit( $this->base_url ) . '/sale.php', array(
					'body' => $args,
		) );
	}
	...
	public function create_user( $user_data ) {
		...
		return wp_remote_post( untrailingslashit( $this->base_url ) . '/API/scripts/new_affiliate.php', array(
			'body' => $args,
		) );
